...
### Descripción
Esta sección contiene el protocolo utilizado para la ejecución del Proyecto "Evaluación de las proteínas del ciclo celular en el cáncer de pene", gestionado por la Dirección de Investigación y Divulgación Científica de la Universidad del Norte. El Programa se ejecuta dentro del *Programa Paraguayo para el Desarrollo de la Ciencia y la Tecnología* (PROCIENCIA), Proyecto 14-INV-323, con fondos adjudicados por el *Consejo Nacional de Ciencia y Tecnología* (CONACYT) de la República del Paraguay según Resolución No. 437/2014.
